...
class OptionsMenu extends MusicBeatState
{
	...
	public function getcontrolmode():Int {
		...
		if (FlxG.save.data.buttonsmode != null) return FlxG.save.data.buttonsmode[0];
		return 0;
	}

	public function setcontrolmode(mode:Int = 0):Int {
		// save control mode num from FlxSave
		if (FlxG.save.data.buttonsmode == null) FlxG.save.data.buttonsmode = new Array();
		FlxG.save.data.buttonsmode[0] = mode;
		FlxG.save.flush();

		return FlxG.save.data.buttonsmode[0];
	}
	...
	public function loadcustom(_pad:FlxVirtualPad):FlxVirtualPad {
		//load pad
		if (FlxG.save.data.buttons == null) return _pad;
		var tempCount:Int = 0;
